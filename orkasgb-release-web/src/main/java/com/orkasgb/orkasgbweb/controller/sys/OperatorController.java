...
public class OperatorController extends BaseController {
    ...
    @RequestMapping(value = "/updatePassword", method = RequestMethod.POST, consumes = "application/json; charset=UTF-8",
            produces = "application/json")
    public ResultVo updatePassword(@RequestBody OperatorEntity operatorEntity) throws GlobalException {
        ResultVo resultVo = new ResultVo<>(CodeEnum.SUCCESS.getStatus(), CodeEnum.SUCCESS.getCode());
        String message = operatorService.updatePassword(operatorEntity);
